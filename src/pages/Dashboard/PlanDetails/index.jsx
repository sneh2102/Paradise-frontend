            ...
            <Row>
                <Col md="3" >
                    <ListGroup variant="flush" className="position-sticky top-0" >
                        <ListGroup.Item action onClick={handleDetailsLinks} style={{backgroundColor:"rgba(51, 72, 63, 0.54)", color:"lightgray"}}>Plan details</ListGroup.Item>
                        <ListGroup.Item action onClick={handleBookingLinks()} style={{backgroundColor:"rgba(51, 72, 63, 0.54)", color:"lightgray"}}>Bookings</ListGroup.Item>
                        <ListGroup.Item action onClick={handleBookingLinks('cancelation')} style={{backgroundColor:"rgba(51, 72, 63, 0.54)", color:"lightgray"}}>Cancel requests</ListGroup.Item>
                        <ListGroup.Item action onClick={handleBookingLinks('canceled')} style={{backgroundColor:"rgba(51, 72, 63, 0.54)", color:"lightgray"}}>Canceled</ListGroup.Item>
                        <ListGroup.Item action onClick={handleBookingLinks('paid')} style={{backgroundColor:"rgba(51, 72, 63, 0.54)", color:"lightgray"}}>Paid</ListGroup.Item>
                        <ListGroup.Item action onClick={handleReviewsLinks} style={{backgroundColor:"rgba(51, 72, 63, 0.54)", color:"lightgray"}}>Reviews</ListGroup.Item>
                    </ListGroup>
                </Col>
