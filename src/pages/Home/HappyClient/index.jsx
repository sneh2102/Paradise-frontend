...
const HappyClient = () => {
    ...
    return (
        <div className="HC" style={{backgroundImage: "linear-gradient(rgb(44, 60, 55),rgb(17, 19, 18) )", paddingBottom: "40px"}}>
        <Container>
            <h4 className="text-center text-uppercase ">happy <span className="text-info">client</span></h4>
            <Row xs={1} md={2} className="g-3">
                <Col>
                    <Container>
                        <Row xs={1} className="gy-3">
                            ...
                            ].map((item, _idx) => <Col key={_idx} className="rounded shadow text-center py-3" style={{color: "darkgray", backgroundColor: "#33483f8a" }}>
                ...
                <Col className="shadow rounded d-flex" style={{ minHeight: 250 }} style={{color: "darkgray", backgroundColor: "#33483f8a" }}>
