...
const ShowPlans = () => {
    ...
    return (
        ...
        //             //     <Plan {...plan} />
        //             // </Col>
        //                 <h1>{plan.coverImageURL}</h1>
        //         ))}
        //     </Row>
        // </Container>
        <section className="pm">
            <h3 className="text-center text-uppercase"><span className="plantext-info">popular</span> plans</h3>
        ...
        <div className="plancont">
          {plans.map((panel, index) => (
            <div
              ...
              style={{ backgroundImage: `url(${panel.coverImageURL})` }}
              onClick={() => handlePanelClick(index)}
            >
              <h3 className='planName'>{panel.name}</h3>
            </div>
          ))}
        </div>
      </div>
